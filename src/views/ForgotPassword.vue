                    ...
                    <div class="row">
                        <div class="mx-auto col-xl-4 col-lg-5 col-md-6 d-flex flex-column">
                            <div class="mt-8 card card-plain">
                                ...
                                <div class="card-body">
                                    <form @submit.prevent="reset" role="form" class="text-start">
                                        <label>Email</label>
                                        <soft-input id="email" type="email" placeholder="Email" name="email"
                                            v-model="email" />
                                ...
                                <div class="px-1 pt-0 text-center card-footer px-lg-2">
                                    <p class="mx-auto mb-4 text-sm">
                                        ...
                                        <router-link :to="{ name: 'Sign In' }"
                                            class="text-success text-gradient font-weight-bold">Login</router-link>
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async reset() {
            ...
            axios.post(`${process.env.VUE_APP_DEV}/auth/forgot-password`, { email: this.email })
                .then(() => {
                    toast("Password Reset Email Sent!", {
                        autoClose: 5000,
                        type: toast.TYPE.SUCCESS
                    });
                    this.text = 'SEND RESET EMAIL';
                })
                .catch(error => {
